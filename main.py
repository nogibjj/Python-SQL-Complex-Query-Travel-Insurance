...
def main():
    ...
    create_travel_insurance_entry(
        (25, "Private Sector", "Yes", 500000, 4, 0, "No", "No", 1)
    )
    update_travel_insurance_entry(
        1, (26, "Private Sector", "Yes", 600000, 5, 1, "Yes", "Yes", 0)
    )
